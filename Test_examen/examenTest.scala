...
class examenTest extends TestInit {
  ...
  "Ejercicio 5" should "calcula el ingreso total" in {
    ...
    val ventas = spark.read
      ...
      .csv("C:\\Users\\jfsch\\Documents\\KeepCoding\\Ejercicios KeeCoding\\BigData_processing\\Practica\\Examen_Final\\bd-processing-entrega\\src\\main\\scala\\examen_estructura\\ventas.csv") // Cambiar esta ruta según tu proyecto
    ...
    out.toList shouldBe List((101,460.0), (102,405.0), (103,280.0),
      ...
      (107,396.0), (108,486.0), (109,540.0), (110,494.0))
  }
